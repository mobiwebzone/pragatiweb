...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    $scope.PAGE_UNDER = "ST_FINAL_RESULT";
    $scope.editMode = false;
    // $scope.WORKING_HOURS=[];

    var url = 'code/StudentFinalResult.php';
        ...
        $scope.staticPageCarousel = function () {
            $http({
                ...
                transformRequest: function (data) {
                    ...
                    formData.append("PAGE", 'STUDENT FINAL RESULT');
                    return formData;
                },
                data: $scope.temp,
                headers: { 'Content-Type': undefined }
    ...
    $scope.getStudentFinalResult = function () {
        ...
        $http({
            ...
            transformRequest: function (data) {
                var formData = new FormData();
                formData.append("type", 'getStudentFinalResult');
                return formData;
            },
            data: $scope.temp,
            headers: { 'Content-Type': undefined }
        ...
        then(function (data, status, headers, config) {
            // console.log(data.data);
            $scope.post.getStudentFinalResult = data.data.success ? data.data.data : [];
