...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout,taOptions) {
    ...
    var url = '../backoffice/code/Essay_Grading_code.php';
    ...
    $scope.getEssays = function () {
        ...
        $http({
            method: 'post',
            url: '../backoffice/code/Essays_code.php',
    ...
    $scope.getStudentEssay = function (GETDETAIL) {
        ...
        $http({
            method: 'post',
            url: url,
            data: $.param({ 'type': 'getStudentEssay', 'ESSID' : $scope.temp.ddlEssay, 'LOCID':$scope.LOC_ID}),
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
        }).
        then(function (data, status, headers, config) {
            // console.log(data.data);
