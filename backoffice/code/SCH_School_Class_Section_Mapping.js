...
$postModule.controller("myCtrl", function ($scope, $http, $interval, $timeout) {
  ...
  var url = "code/SCH_School_Class_Section_Mapping_code.php";
  ...
  $scope.save = function () {
    ...
    $http({
      ...
      transformRequest: function (data) {
        ...
        formData.append("schoolclassid", $scope.temp.schoolclassid);
        formData.append("TEXT_SCHOOL_ID", $scope.temp.TEXT_SCHOOL_ID);
        formData.append("TEXT_CLASS_CD", $scope.temp.TEXT_CLASS_CD);
        formData.append("TEXT_SECTION_CD", $scope.temp.TEXT_SECTION_CD);
        return formData;
      },
      data: $scope.temp,
