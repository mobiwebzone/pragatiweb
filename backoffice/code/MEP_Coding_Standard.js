...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  $scope.PageSub2 = "MEPCODINGSTANDARD";

  var url = "code/MEP_Coding_Standard_code.php";
  ...
  $scope.save = function () {
    ...
    $http({
      ...
      transformRequest: function (data) {
        ...
        formData.append("txtCodingStandardDesc", $scope.temp.txtCodingStandardDesc);
        formData.append("txtExampleDesc", $scope.temp.txtExampleDesc);
        formData.append("txtSampleCode", $scope.temp.txtSampleCode);
  ...
  $scope.edit = function (id) {
    ...
    $scope.temp = {
      pmid: id.CODINGSTANDARDID,
      txTechPlatformId: id.TECHPLATFORMID.toString(),
      ddlfunctionid: id.FUNCTIONID.toString(),
      txtCodingStandardDesc: id.CODINGSTANDARD_DESC,
      txtExampleDesc: id.EXAMPLE_DESC,
      txtSampleCode: id.SAMPLE_CODE,
  ...
  $scope.delete = function (id) {
    ...
    if (r == true) {
      $http({
        method: "post",
        url: url,
        data: $.param({ pmid: id.CODINGSTANDARDID, type: "delete" }),
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
      }).then(function (data, status, headers, config) {
        console.log(data.data);
        if (data.data.success) {
