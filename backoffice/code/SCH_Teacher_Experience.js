...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/SCH_Teacher_Experience_code.php";
    ...
    $http({
      ...
      processData: false,
        ...
        formData.append("type", 'save');
                ...
                formData.append("TEXT_INSTITUTION_NAME", $scope.temp.TEXT_INSTITUTION_NAME);
                formData.append("TEXT_POST_HELD", $scope.temp.TEXT_POST_HELD);
  ...
  $scope.edit = function (id) {
    ...
    $scope.temp = {
    feesid: id.TEACHER_EXPERIENCE_ID,
    TEXT_SCHOOL_ID: id.SCHOOL_ID.toString(),
    TEXT_TEACHER_ID: id.TEACHER_ID.toString(),
    TEXT_POST_HELD: id.POST_HELD,
    TEXT_GROSS_SALARY  : id.GROSS_SALARY,
    TEXT_INSTITUTION_NAME: id.INSTITUTION_NAME,
