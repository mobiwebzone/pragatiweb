...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    $scope.PageSub1 = "STATISTICS_BUDGET";
    ...
    var url = 'code/Statistics_Budget.php';
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% CHANNEL SECTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    // =========== SAVE DATA ==============
    $scope.saveBudget = function(SHID,MONTH,VAL){
        // console.log(`${SHID}  || ${MONTH} || ${VAL}`);
