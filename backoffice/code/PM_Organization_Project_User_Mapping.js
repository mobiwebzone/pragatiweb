...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/PM_Organization_Project_User_Mapping_code.php";
  ...
  $scope.save = function () {
    ...
    $http({
      method: "POST",
        ...
        formData.append("TEXT_ORG_USER_ID", $scope.temp.TEXT_ORG_USER_ID);  
  ...
  $scope.delete = function (id) {
    ...
    if (r == true) {
      $http({
        method: "post",
        url: url,
        data: $.param({ pmid: id.ORG_PROJ_USER_ID, type: "delete" }),
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
      }).then(function (data, status, headers, config) {
        // console.log(data.data);
        if (data.data.success) {
