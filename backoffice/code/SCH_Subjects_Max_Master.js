...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/SCH_Subjects_Max_Master_code.php";
    ...
    $http({
      ...
      processData: false,
        ...
        formData.append("type", 'save');
                formData.append("subjectmaxmarksid", $scope.temp.subjectmaxmarksid);
                ...
                formData.append("TEXT_MAX_MARKS", parseFloat($scope.temp.TEXT_MAX_MARKS));
...
$scope.getSubjects = function () {
  ...
  $scope.edit = function (id) {
    ...
    $scope.temp = {
    subjectmaxmarksid: id.SUBJECT_MAX_MARKS_ID,
