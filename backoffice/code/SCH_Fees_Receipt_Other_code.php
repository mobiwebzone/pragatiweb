 ...
 */
 ...
 function save($mysqli){
     try
     {
	   ...
	   if($row_count == 0)
	   {
		...
		$query="EXEC [STUDENT_FEES_PAYMENT_SP] $actionid,$feespaymentid,$TEXT_SCHOOL_ID,'','','$TEXT_PAYMENT_DATE',$TEXT_FEES_PAID,$TEXT_FEES_FY_YEAR_CD,$userid,'$txtremarks',651 ";
 ...
 function getQuery($mysqli){
		try
	{
       ...
       $query =     "SELECT FEES_PAYMENT_ID,SCHOOL_ID,CONVERT(VARCHAR,PAYMENT_DATE,106)PAYMENT_DATE,FEES_PAID,FEES_FY_YEAR_CD,FEES_FY_YEAR
					,REMARKS   
					FROM STUDENT_FEES_PAYMENT  
					WHERE ISDELETED=0 
					AND   FEES_SOURCE_CD  = 651 ";
...
function delete($mysqli){
	...
	$stmt=sqlsrv_query($mysqli, "EXEC [STUDENT_FEES_PAYMENT_SP] 3,$feespaymentid,'','','','','','',$userid,'',651 ");
