...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    $scope.PageSub = "SCRIPT";
    $scope.PageSub1 = "";
    
    var url = 'code/SCRIPT-MASTER.php';
    ...
    $scope.save = function(){
        ...
        $http({
            ...
            transformRequest: function (data) {
                ...
                formData.append("SCRIPTID", $scope.temp.SCRIPTID);
                formData.append("txtScript", $scope.temp.txtScript);
                return formData;
            },
            data: $scope.temp,
    ...
    $scope.edit = function (id) {
        $scope.temp = {
            ...
            txtScript: id.SCRIPT_NAME
        };
        $scope.editMode = true;
        $scope.index = $scope.post.getScript.indexOf(id);
    }
    ...
    $scope.delete = function (id) {
        ...
        if (r == true) {
            $http({
                method: 'post',
                url: url,
                data: $.param({ 'SCRIPTID': id.SCRIPTID, 'type': 'delete' }),
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
            }).
		    then(function (data, status, headers, config) {
                //  console.log(data.data)
		        if (data.data.success) {
		            var index = $scope.post.getScript.indexOf(id);
		            $scope.post.getScript.splice(index, 1);
