...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    var url = 'code/Question_Master_code.php';
    ...
    $scope.saveData = function(){
        ...
        $http({
            ...
            transformRequest: function (data) {
                ...
                formData.append("txtSection", $scope.temp.txtSection);
    ...
    $scope.editForm = function (id) {
        ...
        $scope.temp = {
            secid:id.SECID,
            txtSection: id.SECTION,
            rdCalcAllow: (id.ALLOWEDCALC).toString(),
        };
        $scope.editMode = true;
        $scope.index = $scope.post.getSectionMaster.indexOf(id);
    }
    /* ============ Edit Button ============= */ 
    ...
    $scope.delete = function (id) {
        ...
        if (r == true) {
            $http({
                method: 'post',
                url: url,
                data: $.param({ 'secid': id.SECID, 'type': 'delete' }),
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
            }).
		    then(function (data, status, headers, config) {
                // console.log(data.data)
		        if (data.data.success) {
		            var index = $scope.post.getSectionMaster.indexOf(id);
		            $scope.post.getSectionMaster.splice(index, 1);
