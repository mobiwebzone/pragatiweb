...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/SCH_Create_New_Organization_code.php";
  ...
  $scope.save = function () {
    ...
    $http({
      ...
      transformRequest: function (data) {
        ...
        formData.append("TEXT_ORG_NAME", $scope.temp.TEXT_ORG_NAME);
        formData.append("TEXT_ADDRESS", $scope.temp.TEXT_ADDRESS);
        formData.append("TEXT_MOBILE_NO", $scope.temp.TEXT_MOBILE_NO);
        formData.append("TEXT_E_MAIL_ID", $scope.temp.TEXT_E_MAIL_ID);
      ...
      if (data.data.success) {
        ...
        $scope.getQuery();
        $scope.clear();
        document.getElementById("TEXT_ORG_NAME").focus();
  ...
  $scope.edit = function (id) {
    ...
    $scope.temp = {
      pmid: id.ORG_ID,
      TEXT_ORG_NAME: id.ORG_NAME,
      TEXT_ADDRESS: id.ADDRESS,
      TEXT_MOBILE_NO: id.MOBILE_NO,
      TEXT_E_MAIL_ID: id.E_MAIL_ID,
  ...
  $scope.delete = function (id) {
    ...
    if (r == true) {
      $http({
        method: "post",
        url: url,
        data: $.param({ pmid: id.ORG_ID, type: "delete" }),
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
      }).then(function (data, status, headers, config) {
        console.log(data.data);
        if (data.data.success) {
