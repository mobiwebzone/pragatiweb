...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/SCH_Time_Table_code.php";
    ...
    $http({
      ...
      processData: false,
        ...
        formData.append("type", 'save');
                formData.append("marksid", $scope.temp.marksid);
                ...
                formData.append("TEXT_DAYOFWEEK_CD", $scope.temp.TEXT_DAYOFWEEK_CD);
...
$scope.getWeekday = function () {
    ...
    $http({
      ...
      function (data, status, headers, config) {
        // console.log(data.data);
        $scope.post.getWeekday = data.data.success ? data.data.data : [];
        $(".SpinBank").hide();
      },
      function (data, status, headers, config) {
         console.log("Failed");
