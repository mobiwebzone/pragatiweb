...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    var url = 'code/ToDoList_code.php';
    ...
    $scope.getTodoId = function(id){
        $scope.SELECTED_TDLID = id.TDLID;
        $scope.temp.txtTodoUpd = id.TODO;
        $scope.temp.ddlStatus = id.TDSTATUS;
    }
    ...
    // =========== UPDATE DATA ==============
    $scope.UpdateData = function(FOR){
        $(".btnUpdTodo").attr('disabled', 'disabled');
        $(".btnUpdTodo").text('Updating...');
        // alert($scope.temp.ddlCollege);
        ...
        $http({
            ...
            transformRequest: function (data) {
                ...
                formData.append("TDLID", $scope.SELECTED_TDLID);
                formData.append("txtTodoUpd", $scope.temp.txtTodoUpd);
        ...
        then(function (data, status, headers, config) {
            ...
            if (data.data.success) {
                $scope.getTODO();
                if(FOR == 'TODO') $('#todoModal').modal('hide');
                if(FOR == 'STATUS') $('#updateStatusModal').modal('hide');
            ...
            $('.btnUpdTodo').removeAttr('disabled');
            $(".btnUpdTodo").text('UPDATE');
        });
    }
    // =========== UPDATE TODO ==============
