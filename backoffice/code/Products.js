...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    var url = 'code/Products_code.php';
    ...
    $scope.saveProduct = function(){
        ...
        $http({
            ...
            transformRequest: function (data) {
                ...
                formData.append("product_id", $scope.temp.product_id);
                formData.append("txtProduct", $scope.temp.txtProduct);
                formData.append("txtProductDesc", $scope.temp.txtProductDesc);
    ...
    $scope.editProduct = function (id) {
        ...
        $scope.temp = {
            ...
            txtProduct: id.PRODUCT,
            txtProductDesc: id.PRODUCT_DESC,
            txtDisplayOrder: Number(id.DISPLAY_ORDER),
            txtDisplayColor: id.DISPLAY_COLOR,
        };
        $scope.editMode = true;
