    ...
    $http({
      ...
      processData: false,
        ...
        formData.append("type", 'save');
                ...
                formData.append("TEXT_MARKS_MASTER_ID", $scope.temp.TEXT_MARKS_MASTER_ID);
  ...
  $scope.getQuery = function () {
    $http({
      ...
      data: $.param({
        ...
        TEXT_EXAM_TYPE_CD_S: $scope.temp.TEXT_EXAM_TYPE_CD_S,
        TEXT_STUDENT_ID_S: $scope.temp.TEXT_STUDENT_ID_S,
        type: "getQuery"
      }),
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
    }).then(
...
$scope.getTotalmarks = function () {
    ...
    $http({
      ...
      data: $.param({
        TEXT_SCHOOL_ID: $scope.temp.TEXT_SCHOOL_ID,
        TEXT_CLASS_CD: $scope.temp.TEXT_CLASS_CD,
        TEXT_SUBJECT_CD: $scope.temp.TEXT_SUBJECT_CD,
      ...
      function (data, status, headers, config) {
        //console.log(data.data);
        $scope.post.getTotalmarks = data.data.success ? data.data.data : [];
        $(".SpinBank").hide();
      },
      function (data, status, headers, config) {
        //console.log("Failed");
  ...
  $scope.edit = function (id) {
    ...
    // TEXT_MARKS_MASTER_ID: id.MARKS_MASTER_ID.toString(),
   ...
   $scope.getStudent();
    ...
    $scope.getTotalmarks();
    $timeout(()=>{
      $scope.temp.TEXT_MARKS_MASTER_ID=id.MARKS_MASTER_ID.toString();
    },500);    
