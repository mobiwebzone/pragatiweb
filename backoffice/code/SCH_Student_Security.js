...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/SCH_Student_Security_code.php";
...
$scope.save = function () {
    ...
    $http({
        ...
        transformRequest: function (data) {
            ...
            formData.append("pmid", $scope.temp.pmid || 0);
            formData.append("TEXT_SCHOOL_ID", $scope.temp.TEXT_SCHOOL_ID || 0);
            formData.append("TEXT_STUDENT_ID", $scope.temp.TEXT_STUDENT_ID || 0);
            formData.append("TEXT_SECURITY_RETURNED_AMOUNT", $scope.temp.TEXT_SECURITY_RETURNED_AMOUNT || 0);
            return formData;
        },
        data: $scope.temp,
