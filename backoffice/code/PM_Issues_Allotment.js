...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    var url = 'code/PM_Issues_Allotment_code.php';
    ...
    $scope.save = function(){
        ...
        $http({
            ...
            transformRequest: function (data) {
                ...
                formData.append("TEXT_TASK_SUB_CAT_ID", $scope.temp.TEXT_TASK_SUB_CAT_ID);
                ...
                formData.append("TEXT_TASK_STATUS_CD", $scope.temp.TEXT_TASK_STATUS_CD);
        ...
        $http({
          ...
          url: url,
            data: $.param({
                ...
                TEXT_ASSIGNED_TO_ID_S: $scope.temp.TEXT_ASSIGNED_TO_ID_S,
...
$scope.getOrganization = function () {
        ...
        $http({
          ...
          url: url,
            data: $.param({
                TEXT_ORG_ID: $scope.temp.TEXT_ORG_ID,
                TEXT_PROJECT_ID: $scope.temp.TEXT_PROJECT_ID,
                TEXT_TASK_CAT_ID: $scope.temp.TEXT_TASK_CAT_ID,
  ...
  $scope.edit = function (id) {
    ...
    $scope.temp = {
      ...
      txtStartDT :(id.STARTDATE && id.STARTDATE.trim() !== '') ? new Date(id.STARTDATE) : null,
      txtEndDT :(id.ENDDATE && id.ENDDATE.trim() !== '') ? new Date(id.ENDDATE) : null,
     
      txtTaskDesc: id.TASK_DESC,
      TEXT_TASK_STATUS_CD: id.TASK_STATUS_CD.toString(),
      remarks: id.REMARKS,
    };
    ...
    $scope.clear = function () {
      document.getElementById("TEXT_ORG_ID").focus();
      $scope.temp.TEXT_TASK_CAT_ID = null;
      $scope.temp.TEXT_TASK_SUB_CAT_ID= null;
      $scope.temp.TEXT_ASSIGNED_TO_ID= null;
      $scope.temp.txtStartDT= null;
      $scope.temp.txtEndDT= null;
      $scope.temp.txtTaskDesc= null;
      $scope.temp.TEXT_TASK_STATUS_CD= null;
