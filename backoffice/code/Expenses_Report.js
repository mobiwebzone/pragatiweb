...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  $scope.temp.TEXT_PAYMENT_DATE_FROM = new Date();
  
  
 

  var url = "code/Expenses_Report_code.php";
  ...
  $scope.getQuery = function () {
    $http({
      ...
      data: $.param({
        ...
        TEXT_PAYMENT_DATE_FROM: $scope.temp.TEXT_PAYMENT_DATE_FROM,
        TEXT_PAYMENT_DATE_TO: $scope.temp.TEXT_PAYMENT_DATE_TO,
        type: "getQuery"
                    }),
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
    }).then(
