...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/SCH_Student_Final_Result_code.php";
    ...
    $http({
      ...
      processData: false,
        ...
        formData.append("type", 'save');
                formData.append("resultid", $scope.temp.resultid);
                ...
                formData.append("TEXT_TOTAL_MARKS", $scope.temp.TEXT_TOTAL_MARKS);
                formData.append("TEXT_MARKS_OBTAINED", $scope.temp.TEXT_MARKS_OBTAINED);
                formData.append("TEXT_TOTAL_DAYS", $scope.temp.TEXT_TOTAL_DAYS);
                formData.append("TEXT_PRESENT_DAYS", $scope.temp.TEXT_PRESENT_DAYS);
...
$scope.getFinancialYear = function () {
  ...
  $scope.edit = function (id) {
    ...
    TEXT_TOTAL_MARKS: id.TOTAL_MARKS,
    TEXT_MARKS_OBTAINED: id.MARKS_OBTAINED,
    TEXT_TOTAL_DAYS: id.TOTAL_DAYS,
    TEXT_PRESENT_DAYS  : id.PRESENT_DAYS,
...
$scope.delete = function (id) {
    ...
    if (r == true) {
      $http({
        method: "post",
        url: url,
        data: $.param({ resultid: id.RESULT_ID, type: "delete" }),
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
      }).then(function (data, status, headers, config) {
