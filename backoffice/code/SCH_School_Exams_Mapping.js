...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
  ...
  var url = "code/SCH_School_Exams_Mapping_code.php";
    ...
    $http({
      ...
      processData: false,
        ...
        formData.append("type", 'save');
                ...
                formData.append("TEXT_CALCULATION_FLAG_CD", $scope.temp.TEXT_CALCULATION_FLAG_CD);
                return formData;
      },
      data: $scope.temp,
...
$scope.getCalculationFlag = function () {
    $scope.post.getCalculationFlag = [];
    ...
    $http({
      ...
      url: url,
      data: $.param({
        type: "getCalculationFlag",
      }),
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
    }).then(
      function (data, status, headers, config) {
        $scope.post.getCalculationFlag = data.data.success ? data.data.data : [];
        $(".SpinBank").hide();
      },
      function (data, status, headers, config) {}
    );
  };
  $scope.getCalculationFlag();
  ...
  $scope.edit = function (id) {
    ...
    $scope.temp = {
    examsid: id.SCHOOL_EXAMS_MAPPING_ID,
    TEXT_SCHOOL_ID: id.SCHOOL_ID.toString(),
    TEXT_EXAM_ID: id.EXAM_ID.toString(),
    TEXT_CALCULATION_FLAG_CD : id.CALCULATION_FLAG_CD.toString()
    };
