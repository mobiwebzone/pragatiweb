 ...
 function getQuery($mysqli){
		try
	{
       ...
       $query =     " SELECT 
					  ...
					  SUM(CASE WHEN FEES_SOURCE_CD = 650 THEN FEES_PAID ELSE 0 END) AS STUDENTS_FEES,
					  SUM(CASE WHEN FEES_SOURCE_CD = 651 THEN FEES_PAID ELSE 0 END) AS OTHER_FEES,
					  (SUM(CASE WHEN FEES_SOURCE_CD = 650 THEN FEES_PAID ELSE 0 END)+SUM(CASE WHEN FEES_SOURCE_CD = 651 THEN FEES_PAID ELSE 0 END)) TOTAL_FEES
