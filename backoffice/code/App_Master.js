...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    $scope.PageSub1 = "APP_MASTER";
    $scope.editMode = false;
    
    var url = 'code/App_Master.php';
    ...
    $scope.saveData = function(){
        ...
        $http({
            ...
            transformRequest: function (data) {
                ...
                formData.append("appid", $scope.temp.appid);
                formData.append("txtAppName", $scope.temp.txtAppName);
                formData.append("txtAppDesc", $scope.temp.txtAppDesc);
    ...
    $scope.editData = function (id) {
        ...
        $scope.temp = {
            appid:id.APPID,
            txtAppName:id.APPNAME,
            txtAppDesc:id.APPDESC,
            txtComments:id.COMMENTS,
        };

        $scope.editMode = true;
        $scope.index = $scope.post.getAppNames.indexOf(id);
    }
    /* ============ Edit Button ============= */ 
    ...
    $scope.deleteData = function (id) {
        ...
        if (r == true) {
            $http({
                method: 'post',
                url: url,
                data: $.param({ 'APPID': id.APPID, 'type': 'deleteData' }),
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
            }).
		    then(function (data, status, headers, config) {
                // console.log(data.data)
		        if (data.data.success) {
		            var index = $scope.post.getAppNames.indexOf(id);
		            $scope.post.getAppNames.splice(index, 1);
