 ...
 */
 ...
 function save($mysqli){
	...
	$sql = "SELECT * FROM TASK_MAIN_CATEGORIES 
		...
		if($row_count == 0)
		{
			$query="EXEC [TASK_MAIN_CATEGORIES_PM] $actionid,$pmid,'$TEXT_ORG_ID','$TEXT_PROJECT_ID','$txtObject','$txtremarks',$userid ";
...
function delete($mysqli){
	try{   
			...
			$stmt=sqlsrv_query($mysqli, "EXEC [TASK_MAIN_CATEGORIES_PM] 3,$pmid,'','','','',$userid ");
			if( $stmt === false ) 
			{
