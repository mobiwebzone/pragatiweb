 ...
 function save($mysqli){
     try
     {
	   ...
	   if($row_count == 0)
	   {
		...
		$query="EXEC [TEACHER_PAYROLL_SP] $actionid,$feesid,$TEXT_SCHOOL_ID,$TEXT_TEACHER_ID,$TEXT_FY_YEAR_CD,$TEXT_SALARY_DUE,'$TEXT_SALARY_DEDUCTED',$TEXT_SALARY_PAID,'$TEXT_DEDUCTION_REASON',$userid,'$txtremarks','$TEXT_PAYMENT_DATE',$TEXT_PAYMENT_MODE_CD,'$TEXT_INSTRUMENT_NO' ";
