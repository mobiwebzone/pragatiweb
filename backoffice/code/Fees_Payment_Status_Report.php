		...
		$query = "SELECT  
          ...
          WHERE A.ISDELETED = 0
            ...
            AND A.SCHOOL_ID = $TEXT_SCHOOL_ID";
				...
				// Second part to calculate the sum of FEES_DUE, FEES_PAID, and FEES_BALANCE
				$query .= " UNION ALL
						SELECT 
							NULL AS FEES_ID,
							A.SCHOOL_ID,
							...
							SUM(A.FEES_DUE) AS FEES_DUE,
							SUM(A.FEES_PAID) AS FEES_PAID,
							SUM(A.FEES_BALANCE) AS FEES_BALANCE
						FROM STUDENT_FEES_MASTER A
						JOIN STUDENT B ON A.STUDENT_ID = B.STUDENT_ID
						WHERE A.ISDELETED = 0
							AND B.ISDELETED = 0
				...
				// Grouping the second query by SCHOOL_ID and FEES_FY_YEAR_CD
				$query .= " GROUP BY A.SCHOOL_ID, A.SCHOOL_NAME, A.FEES_FY_YEAR_CD";
