...
$postModule.controller("myCtrl", function ($scope, $http, $interval, $timeout) {
  ...
  var url = "code/SCH_Salary_Component_Master_code.php";
  ...
  $scope.save = function () {
    ...
    $http({
      ...
      transformRequest: function (data) {
        ...
        formData.append("componentid", $scope.temp.componentid);
       
        formData.append("TEXT_COMPONENT_NAME", $scope.temp.TEXT_COMPONENT_NAME);
        formData.append("TEXT_COMPONENT_TYPE_CD", $scope.temp.TEXT_COMPONENT_TYPE_CD);
      ...
      if (data.data.success) {
        ...
        $scope.getQuery();
        $scope.clear();
        document.getElementById("TEXT_COMPONENT_NAME").focus();
...
$scope.getQuery();
  ...
  $scope.getComponentType = function () {
    ...
    $http({
      ...
      function (data, status, headers, config) {
        //console.log(data.data);
        $scope.post.getComponentType = data.data.success ? data.data.data : [];
        $(".SpinBank").hide();
      },
      function (data, status, headers, config) {
        // console.log("Failed");
  ...
  $scope.edit = function (id) {
    ...
    $scope.temp = {
      componentid: id.COMPONENT_ID,
     
      TEXT_COMPONENT_NAME: id.COMPONENT_NAME,
      TEXT_COMPONENT_TYPE_CD: id.COMPONENT_TYPE_CD.toString(),
