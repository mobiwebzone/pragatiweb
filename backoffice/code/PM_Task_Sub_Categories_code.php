 ...
 */
 ...
 function save($mysqli){
	...
	$sql = "SELECT * FROM TASK_SUB_CATEGORIES 
		...
		if($row_count == 0)
		{
			$query="EXEC [TASK_SUB_CATEGORIES_PM] $actionid,$pmid,'$TEXT_TASK_CAT_ID','$TEXT_ORG_ID','$TEXT_PROJECT_ID','$TEXT_TASK_SUB_CAT','$txtremarks',$userid ";
...
function delete($mysqli){
	try{   
			...
			$stmt=sqlsrv_query($mysqli, "EXEC [TASK_SUB_CATEGORIES_PM] 3,$pmid,'','','','','',$userid ");
			if( $stmt === false ) 
			{
