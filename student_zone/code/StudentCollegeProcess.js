...
$postModule.controller("myCtrl", function ($scope, $http,$interval,$timeout) {
    ...
    var url = '../backoffice/code/Student_College_Process_Details.php';
    ...
    $scope.init = function () {
        ...
        then(function (data, status, headers, config) {
            ...
            if (data.data.success) {
                ...
                // if($scope.userid > 0) $scope.getBusinessProc();
...
/* ######################################################################################################################### */
    ...
    $scope.getStudentCollegeProcess = function () {
        ...
        $http({
             method: 'post',
             url: '../backoffice/code/Student_College_Process.php',
            data: $.param({ 'type': 'getStudentCollegeProcess','FROM':'ST','UID':$scope.userid}),
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
        }).
        then(function (data, status, headers, config) {
            // console.log(data.data);
