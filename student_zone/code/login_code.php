 ...
 */
 ...
 function login($mysqli){
	try{
        ...
        $queryUser = "SELECT REGID FROM REGISTRATIONS WHERE LOGINID='$txtLoginId' AND ISDELETED=0 AND ARCHIVED=0 ORDER BY REGID DESC";
                ...
                if($rowPwd['PWD'] == $txtPWD)
                {
                    ...
                    if($rowApprove['APPROVED'] == 1){
                        ...
                        $logQuery = "INSERT INTO LOGINS_LOG (LOGINTYPE,USERID,LOGINDT,IPADDRESS,LOGINSTATUS)
                                    VALUES ('STUDENT',$ret,GETDATE(),'$IP','SUCCESS')";
                        ...
                        // UPDATE LOG
                        $logQuery = "INSERT INTO LOGINS_LOG (LOGINTYPE,USERID,LOGINDT,IPADDRESS,LOGINSTATUS)
                                    VALUES ('STUDENT',$ret,GETDATE(),'$IP','NOT APPROVED')";
                        sqlsrv_query($mysqli, $logQuery);  
                    }
                    ...
                    // UPDATE LOG
                    $logQuery = "INSERT INTO LOGINS_LOG (LOGINTYPE,USERID,LOGINDT,IPADDRESS,LOGINSTATUS)
                                VALUES ('STUDENT',$ret,GETDATE(),'$IP','FAILED')";
                    sqlsrv_query($mysqli, $logQuery);  
                }
